...
import site.kikihi.custom.platform.adapter.out.jpa.bookmark.BookmarkJpaEntity;
import site.kikihi.custom.platform.adapter.out.jpa.bookmark.BookmarkJpaRepository;
import site.kikihi.custom.platform.adapter.out.jpa.bookmark.projection.ProductIdWithCount;
