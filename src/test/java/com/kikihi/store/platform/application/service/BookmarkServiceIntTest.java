package com.kikihi.store.platform.application.service;

import com.kikihi.store.global.response.ErrorCode;
import com.kikihi.store.platform.adapter.in.web.dto.request.BookmarkRequest;
import com.kikihi.store.platform.adapter.in.web.dto.response.bookmark.BookmarkResponse;
...
import com.kikihi.store.platform.application.out.bookmark.BookmarkPort;
import com.kikihi.store.platform.application.out.user.UserPort;
import com.kikihi.store.platform.domain.bookmark.Bookmark;
import com.kikihi.store.platform.domain.product.Product;
import com.kikihi.store.platform.domain.product.ProductFixtures;
import com.kikihi.store.platform.domain.user.User;
import com.kikihi.store.platform.domain.user.UserFixtures;
